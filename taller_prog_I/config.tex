...
%% Colocamos un tamaño de hoja A4
...
\chead{Apunte Taller de Programación I - FIUBA}  %titulos de la página.
...
\title{Apunte Taller de Programación I - FIUBA}
\author{lcondoriz}
\date{Agosto 2023}
...
\newtcbtheorem[number within=section]{teorema}{Definición}{}{}


\usepackage{multirow} % para las tablas multi columnas
\usepackage{enumitem} % para enumerar con letras
