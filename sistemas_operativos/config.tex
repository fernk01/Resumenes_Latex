...
\newtheorem{answer}{Respuesta}[section]    


\usepackage{mdframed}
\surroundwithmdframed[hidealllines=true,backgroundcolor=blue!20]{theorem}
\surroundwithmdframed[hidealllines=true,backgroundcolor=blue!20]{definition}
\surroundwithmdframed[hidealllines=true,backgroundcolor=blue!20]{exercise}
\surroundwithmdframed[hidealllines=true,backgroundcolor=blue!20]{answer}